...
<script>
    ...
    async function fetchLocations(page = 1) {
        ...
        const entityTypeId = 1080;
        const apiUrl = `${baseUrl}/crm.item.list?entityTypeId=${entityTypeId}&order[id]=desc&select[0]=id&select[1]=ufCrm28Location&start=${(page - 1) * pageSize}`;
        ...
        try {
            ...
            locationList.innerHTML = locations
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">${location.ufCrm28Location || 'N/A'}</td>
    ...
    async function deleteLocation(locationId) {
        const baseUrl = 'https://aghali.bitrix24.com/rest/44/3cb982q5ext2yuma/';
        const apiUrl = `${baseUrl}/crm.item.delete?entityTypeId=1080&id=${locationId}`;
